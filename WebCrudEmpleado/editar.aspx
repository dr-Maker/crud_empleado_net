<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="editar.aspx.cs" Inherits="WebCrudEmpleado.editar" %>
        ...
        <div class="container">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        <div class="col-sm-10">
                            <asp:Button ID="btnGrabar" runat="server" Text="Actualizar" CssClass="btn btn-success" OnClick="btnGrabar_click" />
                        </div>
                    </div>
                </div>
            </div>
